...
# workspaces
#terraform workspaces list #lista los work spaces
#terraform workspaces show default # mostar el work spaces emnq ue trabaj actualmente

#crear un work space terraform workspace new nombre_workspace
 
#workflow
#write --> init--> plan-->  apply -->destroy 
# terraform apply-- auto-- approve #se utiliza para una conmfirmacion automatica 
#terraform refersh # refrescar los cambios
#terraform plan  - refresh -only #muestra cambios manuales son integra la estado


resource "azurerm_resource_group" "rg" {
  name     = "oscar-rg-${terraform.workspace}"
  location = "eastus"
  tags = {
    Project="Terraform"
    Owner="Oscar"
